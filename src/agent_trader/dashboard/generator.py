...
DASHBOARD_HTML = dedent(
    ...
    <body>
      ...
      <script>
        ...
        const supportingArticlesForSymbol=(analysis,headlines)=>dedupeArticles([...arr(analysis.supporting_articles),...arr(headlines)]);
