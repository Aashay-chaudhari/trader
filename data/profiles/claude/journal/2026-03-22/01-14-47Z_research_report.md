...
> LLM analysis failed: anthropic/claude-sonnet-4-6: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CZHEUAtSiAyBuhMskW3QK'}
...
- cli:claude | gpt-4o-mini | error | 1779.4 ms | Credit balance is too low
- anthropic | claude-sonnet-4-6 | error | 123.3 ms | Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing 
