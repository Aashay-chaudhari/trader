...
> Live conditions do not confirm the morning execution setups for any of the candidates.
...
- **Request ID:** `req_b332bcba9b80427ab088a94aea3e1e64`
- **LLM Latency:** 7210.9 ms
...
- openai | gpt-4o-mini | success | 7210.9 ms
...
- **Texas Capital Wealth Management Increases TCBI Holdings** [Motley Fool]
...
|--------|--------|----------|----------|-----------|
| **KBH** | SELL | 0.25 | combined(trend+relative_strength) | Downtrend: price < SMA20 (52.14) < SMA50 (52.90) | Underperforming market by -2. |
...
| Metric | Value |
|--------|------:|
| **Total Value** | $119,440.72 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+19,440.72 (+19.44%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 403 | $0.00 | $48.24 | $19,440.72 | +$19,440.72 (+0.00%) |
