...
> Live conditions are not confirming the morning execution conditions for all candidates.
...
- **Token Usage:** input=806, output=496, total=1302
- **Capacity Before First Request (estimate):** 200,511 tokens remaining
- **Request ID:** `req_0b8c6da4e3604b469abc69004e255b58`
- **LLM Latency:** 9715.9 ms
...
- openai | gpt-4o-mini | success | 9715.9 ms
...
|--------|--------|----------|----------|-----------|
| **KBH** | SELL | 0.26 | combined(trend+relative_strength) | Downtrend: price < SMA20 (52.13) < SMA50 (52.89) | Underperforming market by -3. |
...
- **KBH** (sell): Signal strength 0.26 below minimum 0.3
...
| Metric | Value |
|--------|------:|
| **Total Value** | $119,323.85 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+19,323.85 (+19.32%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 403 | $0.00 | $47.95 | $19,323.85 | +$19,323.85 (+0.00%) |
