...
> Live conditions improved versus the morning tape, but the listed setups still lack complete candidate-specific execution confirmation.

### NKE [?]
- **Sentiment:** N/A | **Confidence:** 30% | **Recommendation:** watch

### MU [?]
- **Sentiment:** N/A | **Confidence:** 28% | **Recommendation:** watch
...
- **Comcast Surges on Media Spinoff Plan** [GuruFocus.com]
...
- **Structured file:** `data/profiles/codex/decision_journal/2026-06-29/19-38-36_20260629_193552.json`
...
| **AVAV** | skipped | planned | buy_today_if_confirmed | 0.58 | 0.31 | After-close earnings create event risk, so the setup needs price strength and sm |
