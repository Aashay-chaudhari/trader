...
> Live conditions are not confirming the morning thesis for these candidates.
...
- **Token Usage:** input=806, output=481, total=1287
- **Capacity Before First Request (estimate):** 200,496 tokens remaining
- **Request ID:** `req_529687a55ded43858dd10076d9fe3337`
- **LLM Latency:** 8721.3 ms
...
- openai | gpt-4o-mini | success | 8721.3 ms
...
| Metric | Value |
|--------|------:|
| **Total Value** | $146,505.20 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+46,505.20 (+46.51%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 952 | $0.00 | $48.85 | $46,505.20 | +$46,505.20 (+0.00%) |
