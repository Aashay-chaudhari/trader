...
> Live conditions are confirming the morning thesis for KBH but not for RCL and NVDA.
...
- **Token Usage:** input=807, output=518, total=1325
- **Capacity Before First Request (estimate):** 200,535 tokens remaining
- **Request ID:** `req_4421cf3b66954b7d8c8a66ea546ee5c7`
- **LLM Latency:** 11328.4 ms
...
- openai | gpt-4o-mini | success | 11328.4 ms
...
|--------|--------|----------|----------|-----------|
| **KBH** | BUY | 0.48 | combined(mean_reversion+support_resistance+vwap) | Price (46.07) at lower BB (45.25) | Price (46.07) near support (45.76) | Price ( |
...
- **KBH** BUY 108 shares @ ~$0.00 = $4,975.56 [SUBMITTED]

## Portfolio Snapshot

| Metric | Value |
|--------|------:|
| **Total Value** | $128,425.19 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+28,425.19 (+28.43%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 617 | $0.00 | $46.07 | $28,425.19 | +$28,425.19 (+0.00%) |
