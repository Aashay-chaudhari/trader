...
> Live conditions are mixed and do not confirm the morning thesis for any candidates.
...
- **Token Usage:** input=806, output=473, total=1279
- **Capacity Before First Request (estimate):** 200,489 tokens remaining
- **Request ID:** `req_5d399ff9e7a64bbba6567f4a29d31731`
- **LLM Latency:** 6897.7 ms
...
- openai | gpt-4o-mini | success | 6897.7 ms
...
| Metric | Value |
|--------|------:|
| **Total Value** | $149,189.84 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+49,189.84 (+49.19%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 952 | $0.00 | $51.67 | $49,189.84 | +$49,189.84 (+0.00%) |
