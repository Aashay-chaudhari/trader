...
- **Token Usage:** input=807, output=504, total=1311
- **Capacity Before First Request (estimate):** 200,520 tokens remaining
- **Request ID:** `req_c486e9b0fed94d33b3a1d1f39d742da0`
- **LLM Latency:** 7668.2 ms
...
- openai | gpt-4o-mini | success | 7668.2 ms
...
|--------|--------|----------|----------|-----------|
| **KBH** | BUY | 0.25 | combined(support_resistance+vwap) | Price (45.47) near support (45.03) | Price (45.47) is -4.9% below VWAP (47.82) | |
...
| Metric | Value |
|--------|------:|
| **Total Value** | $147,965.58 |
| **Cash** | $100,000.00 |
| **Invested** | $0.00 |
| **Total P&L** | $+47,965.58 (+47.97%) |
| **Positions** | 1 |
...
|--------|-------:|---------:|--------:|------:|----:|
| KBH | 1055 | $0.00 | $45.47 | $47,965.58 | +$47,965.58 (+0.00%) |
