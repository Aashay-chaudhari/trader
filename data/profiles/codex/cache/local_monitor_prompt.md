...
|-------|-------|------|-----|----------|--------------|-----------|-----------|
| QCOM  | $  218.24 |  +1.9% |  53 |     0.2x | yahoo_1m | 22s |         9 |
| HOOD  | $  108.36 | +12.1% |  71 |     0.9x | yahoo_1m | 24s |        12 |
| GM    | $   82.24 |  -0.3% |  55 |     0.3x | yahoo_1m | 23s |         9 |
...
- qqq_trend: bullish (1); QQQ change=0.47
- small_cap_breadth: unknown (0); not available
- vix_direction: bullish (1); VIX level=normal, change=-2.62
