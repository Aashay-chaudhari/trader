...
## Monitor Candidates
  ...
  XOM: watch | entry=$144.0 stop=$148.5 target=$137.0
    ...
    Why it is being checked now: price is within 1.7% of entry; price is near stop loss; price is near target; 9 fresh headline(s)
  JBL: watch | entry=$390.0 stop=$378.0 target=$412.0
    ...
    Why it is being checked now: price is within 1.1% of entry; 8 fresh headline(s)

## Live Market Snapshot

| Stock | Price | Chg% | RSI | VolRatio | Quote source | Quote age | Headlines |
|-------|-------|------|-----|----------|--------------|-----------|-----------|
| UAL   | $  120.56 |  +4.4% |  67 |     0.7x | yahoo_1m | 18s |         8 |
| XOM   | $  141.57 |  -3.7% |  37 |     0.6x | yahoo_1m | 18s |         9 |
| JBL   | $  385.55 |  +0.2% |  61 |     0.3x | yahoo_1m | 19s |         8 |

## Active Positions

  UAL: 42 shares @ $118.10, now $118.10 (+0.0%)
