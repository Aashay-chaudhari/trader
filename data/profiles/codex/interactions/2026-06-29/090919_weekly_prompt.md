...
You are the **codex** trading strategist conducting your weekly review.
...
1. `data/profiles/codex/observations/daily/` — all daily observations this week
2. `data/profiles/codex/journal/` — journal entries from each trading day
...
5. `data/profiles/codex/knowledge/` — all 4 knowledge files
6. `data/profiles/codex/IMPROVEMENT_PROPOSALS.md` — pending proposals
...
File: `data/profiles/codex/observations/weekly/week_YYYY-MM-DD.json`
...
```bash
git add data/profiles/codex/observations/weekly/ \
