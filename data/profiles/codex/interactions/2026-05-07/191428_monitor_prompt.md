...
MONITOR CANDIDATES:
  KBH: buy | entry=$51.35 stop=$49.8 target=$54.9
    ...
    Why it is being checked now: active position needs supervision; 17 fresh headline(s)
  RCL: watch | entry=$264.0 stop=$256.0 target=$279.0
    ...
    Why it is being checked now: 11 fresh headline(s)
...
ACTIVE POSITIONS:
  KBH: 403 shares @ $0.00, now $48.88 (+0.0%)
