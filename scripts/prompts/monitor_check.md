...
- `data/profiles/{{PROFILE}}/cache/local_monitor_context.json`
- `data/profiles/{{PROFILE}}/cache/local_monitor_prompt.md`

Then write:

- `data/profiles/{{PROFILE}}/cache/local_monitor_decision.json`
