...
You are the **codex** trading strategist speaking honestly to your
...
1. `data/profiles/codex/profile.json`
2. `data/profiles/codex/cache/morning_research.json`
3. `data/profiles/codex/cache/watchlist.json`
4. `data/profiles/codex/observations/daily/` - read the most recent daily observation
5. `data/profiles/codex/knowledge/lessons_learned.json`
6. `data/profiles/codex/knowledge/patterns_library.json`
7. `data/profiles/codex/knowledge/strategy_effectiveness.json`
8. `data/profiles/codex/knowledge/regime_library.json`
9. `data/profiles/codex/IMPROVEMENT_PROPOSALS.md`
10. `data/profiles/codex/improvement_proposals.json`
11. `data/profiles/codex/portfolio_state.json`
12. `data/profiles/codex/snapshots/latest.json`
13. `data/profiles/codex/snapshots/history.json`
14. `data/profiles/codex/voice/latest_voice.json` if it exists
...
1. `data/profiles/codex/voice/voice_YYYY-MM-DD.json`
2. `data/profiles/codex/voice/latest_voice.json`
...
```bash
git add data/profiles/codex/voice/
```
...
- [ ] JSON is valid
- [ ] Wrote ONLY to `data/profiles/codex/voice/`
