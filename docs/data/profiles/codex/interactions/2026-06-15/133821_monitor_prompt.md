...
## Monitor Candidates
  ...
  DAL: buy | entry=$86.2 stop=$83.8 target=$90.0
    ...
    Why it is being checked now: price is within 0.9% of entry; 9 fresh headline(s)
  JBL: watch | entry=$390.0 stop=$378.0 target=$412.0
    ...
    Why it is being checked now: price is within 1.5% of entry; 8 fresh headline(s)

## Live Market Snapshot

| Stock | Price | Chg% | RSI | VolRatio | Quote source | Quote age | Headlines |
|-------|-------|------|-----|----------|--------------|-----------|-----------|
| XOM   | $  138.14 |  -6.1% |  33 |     0.1x | yahoo_1m | 22s |         9 |
| DAL   | $   86.96 |  +4.7% |  68 |     0.2x | yahoo_1m | 20s |         9 |
| JBL   | $  395.72 |  +2.8% |  64 |     0.1x | yahoo_1m | 23s |         8 |
