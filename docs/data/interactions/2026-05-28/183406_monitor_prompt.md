...
MONITOR CANDIDATES:
  RCL: watch | entry=$264.0 stop=$256.0 target=$279.0
    ...
    Why it is being checked now: 10 fresh headline(s)
  ...
  CCL: buy | entry=$24.6 stop=$23.85 target=$26.4
    Execution condition: Only buy if CCL holds above 24.40 after the open while crude remains weak and the stock can sustain trade through the 24.80 to 25.00 area on above-average volume.
    Why it is being checked now: 25 fresh headline(s)
...
ACTIVE POSITIONS:
  KBH: 952 shares @ $0.00, now $49.24 (+0.0%)
