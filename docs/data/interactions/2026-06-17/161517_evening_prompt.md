...
You are the **codex** trading strategist reviewing today's session. Your
...
`data/profiles/codex/`. Lessons, patterns, and observations must come
...
1. `data/profiles/codex/journal/<TODAY>/` — every journal entry from today
2. `data/profiles/codex/portfolio_state.json` — positions after today's trades
3. `data/profiles/codex/snapshots/latest.json` — end-of-day portfolio
4. `data/profiles/codex/snapshots/history.json` — portfolio value curve
5. `data/profiles/codex/knowledge/lessons_learned.json` — current lessons
6. `data/profiles/codex/knowledge/patterns_library.json` — known patterns
7. `data/profiles/codex/observations/daily/` — last 3 daily observations
8. `data/profiles/codex/cache/morning_research.json` — what you planned this morning
9. `data/profiles/codex/cache/watchlist.json` — the stocks you were watching
10. `data/profiles/codex/decision_journal/<TODAY>/` — structured monitor decisions, including skipped and rejected setups
...
File: `data/profiles/codex/observations/daily/obs_YYYY-MM-DD.json`
...
File: `data/profiles/codex/IMPROVEMENT_PROPOSALS.md`
...
Also write structured JSON to `data/profiles/codex/improvement_proposals.json`.
...
```bash
git add data/profiles/codex/observations/ \
        data/profiles/codex/knowledge/ \
        data/profiles/codex/IMPROVEMENT_PROPOSALS.md \
        data/profiles/codex/improvement_proposals.json
```
