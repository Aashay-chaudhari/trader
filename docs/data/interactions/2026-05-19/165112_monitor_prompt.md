...
MONITOR CANDIDATES:
  KBH: buy | entry=$51.35 stop=$49.8 target=$54.9
    ...
    Why it is being checked now: active position needs supervision; 13 fresh headline(s)
  ...
  NVDA: watch | entry=$173.5 stop=$168.3 target=$181.5
    ...
    Why it is being checked now: 21 fresh headline(s)
...
ACTIVE POSITIONS:
  KBH: 1055 shares @ $0.00, now $44.67 (+0.0%)
